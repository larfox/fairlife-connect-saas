...
DROP TRIGGER IF EXISTS trigger_know_your_numbers_completion ON public.service_queue CASCADE;
DROP FUNCTION IF EXISTS public.handle_know_your_numbers_completion() CASCADE;
